    ...
    <>
        ...
        <div className="section-container">
          ...
          <div className="donate-content">
            <div className="donate-text">
              <p>
                Desert Storm Robotics is a student-led FRC team committed to
                bringing STEM education and competitive robotics to rural
                Arizona. Your donation helps fund life-changing experiences in
          ...
          <h2 className="section-title donation-tiers-title">
            Support Our Team
          </h2>
          <p>
            Your donation helps us build robots and opportunities for students.
          </p>
            ...
            <div className="section-container">
              ...
              <div className="payment-methods-container">
                <div className="paypal-container">
                  ...
                  <p className="paypal-donation-text">
      ...
      <footer className="footer">
        <div className="footer-bottom">
          <p>
            &copy; {new Date().getFullYear()} Desert Storm. All rights reserved.
          </p>
        </div>
      </footer>
    </>
